...
def _schema(table: str, fields: tuple[Any, ...]) -> pa.Schema:
    return pa.schema(
        ...
        metadata={
            b"flamo.table": table.encode(),
            b"flamo.schema.major": str(SCHEMA_MAJOR).encode(),
            b"flamo.schema.minor": str(SCHEMA_MINOR).encode(),
        },
    )
...
SCHEMAS: dict[str, pa.Schema] = {
    ...
    "variants": _schema(
        ...
        (
            ...
            pa.field("source_state_id", pa.string(), nullable=False),
            pa.field("workload_instance_id", pa.string(), nullable=False),
